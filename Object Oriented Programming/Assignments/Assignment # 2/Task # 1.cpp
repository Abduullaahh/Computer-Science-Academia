...
//---------------------------------------
char* Garment::getName() { return name; }
//------------------------------------------------------------------
//                 UPPER GARMENTS
//------------------------------------------------------------------
...
//---------------------------------------
Upper::Upper(char* Name = 0, int CollorSize = 0) : Garment(Name) { collorSize = CollorSize; }
//------------------------------------------------------------------
...
//---------------------------------------
int Shirt::getCollorSize() { return Upper::collorSize; }
//------------------------------------------------------------------
//                 LOWER GARMENTS
//------------------------------------------------------------------
...
//---------------------------------------
Lower::Lower(char* Name = 0, int Waist = 0) : Garment(Name) { waist = Waist; }
//------------------------------------------------------------------
...
//---------------------------------------
int Pajama::getWaist() { return Lower::waist; }
//---------------------------------------
...
//---------------------------------------
int Trouser::getWaist() { return Lower::waist; }
//---------------------------------------
...
int main()
{
	...
	do {
		...
		case 1:
		{
			...
			cout << "\nTotal items in cart : " << cart << endl << "Note : Max items can be 10\n";
			system("pause");
			break;
		}
		case 2:
	...
	for (int i = 0; i < 10; i++) { delete[]ShoppingCart[i]; } delete[]ShoppingCart; ShoppingCart = NULL;
}
//------------------------------------------------------------------
//------------------------------------------------------------------